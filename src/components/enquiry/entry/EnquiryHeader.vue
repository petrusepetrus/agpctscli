...
Initialisation
-------------------------------------------------------------------------------*/
let {value: first_name}: FieldContext<string> = useField('first_name')
let {value: last_name}: FieldContext<string> = useField('last_name')
let {value: email} :FieldContext<string>= useField('email')
let {value: phone_number}:FieldContext<string> = useField('phone_number')
let {value: country} :FieldContext<string>= useField('country')
let {value: international_dialling_code} :FieldContext<string>= useField('international_dialling_code')
let {value: phone_type}:FieldContext<string> = useField('phone_type')
let {value: enquiry_type} :FieldContext<string>= useField('enquiry_type')
/*
