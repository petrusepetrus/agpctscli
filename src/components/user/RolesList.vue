<template>
    <div class="pt-2 sm:flex sm:items-center sm:justify-between">
        <div class="sm:flex-auto">
            <h3 class="text-lg font-medium text-teal-500">Roles</h3>
    ...
    <div v-if="flgProcessForm">
        <form novalidate class="space-y-6 " @submit="onSubmit">
            <fieldset class="grid grid-cols-4 col-span-4">
                <div v-for="userType in userStore.userTypes" :key="userType.id" class="mt-4 md:col-span-1 col-span-4 space-y-4">
...
let flgIsDirty = ref(false)                         /*flags whether the form is dirty */
...
/* load the user types for this user */
loadUserTypes()
/*
-------------------------------------------------------------------------------
Functions
...
const onChange = (event) => {
    ...
    ////console.log("form is dirty " + flgIsDirty.value)
}
async function loadUserTypes () {
    ...
    try {
       ...
       flgProcessForm.value=true
        ...
        flgProcessForm.value=false
        await errorMessageHandler(e,errorMessage)
    }
